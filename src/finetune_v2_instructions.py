...
DATA_FILE = Path(
    r"C:\AI-Project\data\instruction_train_v3.jsonl"
)
...
BASE_MODEL_FILE = Path(
    r"C:\AI-Project\checkpoints\v2\final_model_v2_3000.pt"
)

OUTPUT_FILE = Path(
    r"C:\AI-Project\checkpoints\v2\instruction_model_v3.pt"
)
