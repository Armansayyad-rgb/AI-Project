...
# Project paths (mirrors rag_chat_v2.py constants, sourced from root config)
SRC_DIR = PROJECT_ROOT / "src"
DATA_DIR = PROJECT_ROOT / "data"
UPLOADS_DIR = DATA_DIR / "uploads"

# Generated artifacts (UI-side)
...
# RAG tunables (mirrors rag_chat_v2.py line 98-100)
...
MAX_UPLOADED_CHUNKS = 5000                    # hard cap on knowledge base size
